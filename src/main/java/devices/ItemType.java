...
public enum ItemType {
  ...
  /**
   * set the code for each items in the enum when they are created.
   *
  ...
  /**
   * with a unknown enum type but a valid code this will return the Item type that co-responds to
   * the code provided.
   *
