...
/**
 * Creates Objects of Products and Assigns and create
 * the specific type provided from the user.
 * @author Brandon Heck
 */
public class Widget extends Product {
  ...
  /**
   * Constructor for Widgets in the System (When creating a new Product)
  ...
  /**
   * Mutator to set the [String] information from the additional
   * product information window into the specific product type.
  ...
  /**
   * Mutator to set the [Integer] information from the additional
   * product information window into the specific product type.
